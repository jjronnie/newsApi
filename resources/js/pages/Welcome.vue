...
<template>
    ...
    >
        <header
            class="mb-6 w-full max-w-83.7 text-sm not-has-[nav]:hidden lg:max-w-4xl"
        >
        ...
        >
            <main
                class="flex w-full max-w-83.7 flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row"
            >
                <div
